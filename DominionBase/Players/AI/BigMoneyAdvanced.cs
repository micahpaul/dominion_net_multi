...
{
	public class BigMoneyAdvanced : Standard
	{
		public new static String AIName { get { return "Big Money (Advanced)"; } }
		public new static String AIDescription { get { return "Similar to Big Money, but opens up buying to Action cards that provide +Cards."; } }
		
		public BigMoneyAdvanced(Game game, String name) : base(game, name) { }
		public BigMoneyAdvanced(Game game, String name, Player realThis) : base(game, name, realThis) { }
